...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_mhgsLogo->fn->setPosition(Screen0_mhgsLogo, 105, 152);
    ...
    Screen0_fastLabel->fn->setPosition(Screen0_fastLabel, 363, 230);
    ...
    Screen0_easyLabel->fn->setPosition(Screen0_easyLabel, 438, 230);
    ...
    Screen0_smartLabel->fn->setPosition(Screen0_smartLabel, 513, 230);
    ...
    Screen0_qsButton->fn->setPosition(Screen0_qsButton, 633, 399);
